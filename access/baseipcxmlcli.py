...
_log = _tools.getLogger("baseipcxmlcli")
_log.setFile("baseipcxmlcli.log",dynamic=True)
_log.setFileFormat("simple")
_log.setFileLevel("info")
_log.setConsoleLevel("result")

class baseipcAccess(_cliutil.cliaccess):
	def __init__(self):
		super(baseipcAccess,self).__init__("baseipc")
